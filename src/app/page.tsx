...
export default function Home() {
  return (
    <>
      ...
      <section className="bg-cream-soft dark:bg-cream-dark pt-6 pb-12 lg:pt-10 lg:pb-24 border-b border-stone-200/20 px-6 md:px-12 lg:px-16">
      ...
      <main className="p-6 md:p-12">
        <div className="max-w-6xl mx-auto text-center py-20">
          <h2 className="text-2xl font-bold">محتوای تکمیلی صفحه اصلی اینجا قرار می‌گیرد...</h2>
        </div>
      </main>
    </>
  );

    ...
    <div className="flex min-h-screen bg-stone-100 dark:bg-stone-950">
      <aside className="w-64 bg-white dark:bg-stone-900 border-l border-stone-200 dark:border-stone-800 p-6 flex flex-col shrink-0">
        ...
        <nav className="space-y-2 flex-1">
          <AdminNavLink href="/x7k9m2p4" icon={LayoutDashboard} label="داشبورد" />
          <AdminNavLink href="/x7k9m2p4/posts" icon={FileText} label="مدیریت پست‌ها" />
          <AdminNavLink href="/x7k9m2p4/users" icon={Users} label="کاربران" />
          <AdminNavLink href="/x7k9m2p4/comments" icon={Settings} label="کامنت ها" />
        </nav>

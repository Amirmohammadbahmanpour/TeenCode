...
import { CheckCircle2, ChevronRight, ChevronLeft, Send, Sparkles, Loader2 } from "lucide-react";
...
export default function QuizClient({ userId, questions, examType, courseId }: QuizProps) {
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        try {
            ...
            await api.post("/user-exams", examData);
            ...
            let errorMessage = "خطا در ثبت نمره";
    ...
    if (!currentQuestion) {
        return (
            <div className="max-w-2xl mx-auto bg-white dark:bg-stone-900 rounded-[2.5rem] p-12 text-center">
                <Loader2 className="animate-spin text-sage-600 mx-auto" size={40} />
                <p className="mt-4 text-stone-500">در حال بارگذاری سوالات...</p>
            </div>
        );
    }
